...
path <- "/Users/colleenmccamy/Documents/MEDS/Capstone/data/"
```

## Read in the Wind Data
```{r}
# reading in shapefile from power of place
old_exisiting_wind <- st_read("/Users/colleenmccamy/Documents/MEDS/Capstone/data/united_states_wind_turbines/uswtdb_v5_3_20230113/uswtdb_v5_3_20230113.shp")

#crs(old_exisiting_wind) # checking to see that it is in NAD83 crs

# reading in shapefile from power of place
wind_proj <- read_csv(paste0(path,                "exisitingWindContUS/uswtdb_v4_3_20220114_ucsb.csv"))
...
#st_write(wind_proj_contiguous, paste0(path, "existing_wind_contiguous_us.shp"))
```
...
# export as csv
write.csv(pid_coords, paste0(path, "us_PID_cords.csv"), row.names = FALSE)

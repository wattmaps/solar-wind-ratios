...
# Define input folder
inputFolder = os.path.join(current_dir, 'Documents', "Wattmaps", "Data")
...
def runOptimization(PID):
    ...
    def pyomoInput_matrixToDict(df, i_indexName, j_indexNames_list):
        ...
        ## melted all the j_indexNames_list (columns) into single "variable" column --> make this the second index
